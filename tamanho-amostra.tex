...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{leads\_mean }\OtherTok{\textless{}{-}} \FunctionTok{mean}\NormalTok{(df\_leads\_complete\_filtered}\SpecialCharTok{$}\NormalTok{leads)}
\NormalTok{leads\_sd }\OtherTok{\textless{}{-}} \FunctionTok{sd}\NormalTok{(df\_leads\_complete\_filtered}\SpecialCharTok{$}\NormalTok{leads)}
