...
<script type="text/javascript">
  $(document).ready(function() {
    ...
    $('p>img.chart-image').each(function(index) {
      ...
      // Add class couter
      $(this).addClass(`chart-image-${index}`);
      // Button
      $(this).parent().append(
      ...
      $(this).siblings('#chart-zoom-button').on('click', function() {
        ...
        $(`img.chart-image-preview`).attr('src', $(`img.chart-image-${chartIndex}`).attr('src'));
...
Apesar de dar a impressão de estar correto, o gráfico nos mostra que estamos errando além do esperado a maioria das vezes. Isso indica que a amostra não é suficiente para garantir a precisão desejada. Consequentemente, não podemos ter confiança que teremos uma estimativa precisa da média diária de leads.
