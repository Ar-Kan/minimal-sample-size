...
Estimar a quantidade total de leads mensais, com 80% de confiança, por anunciante, de anúncios de vendas de imóveis na cidade de Florianópolis (SC).
...
usando uma amostra dos anúncios. A partir dos dados coletados, será possível estimar a quantidade total de leads mensais.
...
<button class="btn btn-primary" data-toggle="collapse" data-target="#answer-dist">Resposta</button>  
