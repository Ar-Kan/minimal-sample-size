...
- **Desvio padrão dos leads diários**: indica o quanto os leads variam de um dia para o outro.
...
Apesar de parecer "correto" quando analisamos o todo, o gráfico nos mostra que estamos errando além do esperado a maioria das vezes. Isso indica que a amostra não é suficiente para garantir a precisão desejada.
...
- **Independência**: outro fator que exerce influência sobre esse erro é a falta de independência entre os dados. Isto é, os dados utilizados formam uma série temporal, o que faz com que qualquer estatística utilizada seja dependente do tempo. Isso torna incorreta a técnica de estimação do tamanho da amostra, pois tem como premissa a independência dos dados.
